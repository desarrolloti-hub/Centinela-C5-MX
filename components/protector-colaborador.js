Ri// protector-colaborador.js
    ...
    (async function () {
        ...
        const MODULOS = {
            ...
            riesgo: { nombreAmigable: 'RiesgoNivel', requierePermiso: true },
        ...
        class ProtectorColaborador {
                        ...
                        try {
                            ...
                            if (permiso) {
                                this.permisos = {
                                    ...
                                    riesgo: permiso.puedeAcceder('riesgo') || false
                                };
                                return;
                            }
                        } catch (error) {
            ...
            _tienePermisoModulo(modulo) {
                ...
                switch (modulo) {
                    ...
                    case 'riesgo': return this.permisos.riesgo === true;
